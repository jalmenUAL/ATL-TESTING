...
public class ATLLauncher {
	...
	public void launch(String inMetamodelName,String inMetamodelPath, String inModelPath, String outMetamodelName, String outMetamodelPath,
	...
	public static void atl(String Imetamodel, String Imetamodelname,String Ometamodel, String Ometamodelname,
			String Imodel, String Omodel, String TransformationDir, String TransformationModule)
			{
		ATLLauncher l = new ATLLauncher();
		l.registerInputMetamodel(Imetamodel);
		l.registerOutputMetamodel(Ometamodel);
		l.launch(Imetamodelname,Imetamodel, Imodel, Ometamodelname,Ometamodel, Omodel, TransformationDir, TransformationModule);
			}
	...
	public static void main(String ... args){
		...
		l.launch(IN_METAMODEL_NAME,IN_METAMODEL, IN_MODEL, OUT_METAMODEL_NAME,OUT_METAMODEL, 
				OUT_MODEL, TRANSFORMATION_DIR, TRANSFORMATION_MODULE);
	}
}
