...
let $namespaces := (namespace {""} {"http://Families/1.0"}, namespace {"xmi"} {"http://www.omg.org/XMI"}, attribute {"xmi:version"} {"2.0"})
let $imm := "Families.ecore"
let $schema := "Schema.xsd"
let $in := "Families"
let $omm := "Persons.ecore"
let $on := "Persons"
let $f :="/Users/jesusmanuelalmendrosjimenez/Dropbox/research/test_cases/TESTING ATL/TESTING/wp-drop-atl/ATL-Testing/Families2Persons/"
let $t := "Families2Persons"
let $pinput := "Families_Properties"
let $poutput := "Persons_Properties"
